...
public class img {
    //日志记录对象
    private final Logger logger = LoggerFactory.getLogger("com.lzk.controller.Img");
    @Autowired
    ...
    @PostMapping("/delImg")
    public Result delImg(@RequestBody com.lzk.entity.Img request){
    ...
    public Result changeImg(@RequestBody com.lzk.entity.Img request){

...
import com.defectscan.service.SafeTypeService;
...
@ResponseBody // 返回JSON
@CrossOrigin("*") // 允许跨域
@RequestMapping("/api/safeType")
public class safeType {
    //日志记录对象
    private final Logger logger = LoggerFactory.getLogger("com.defectscan.controller.safeType");
